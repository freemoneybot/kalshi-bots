...
HALF_STOP_BY_MIN = 8.0    # half the entry BEFORE this minute. See the block in
                ...
                if pos["ticker"] != m["ticker"]:
                    ...
                    if reason:
                        ...
                        reason = (f"cut at {c(bid)}c - the bid halved to at or below "
                                  ...
                                  f"at minute {minute:.1f}, before the minute "
                                  f"{HALF_STOP_BY_MIN:.0f} cutoff. In our own tape an "
                                  f"early halving was terminal in 25 of 25 rounds - "
                                  f"none recovered to entry")
