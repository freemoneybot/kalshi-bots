...
HALF_STOP_FRAC = 0.0     # cheap-side only: cut if the bid trades at or below
HALF_STOP_BY_MIN = 999.0   # no minute cutoff (worker b7d16102, Sep 16): the
            ...
            if pos:
                if pos["ticker"] != m["ticker"]:
                    ...
                    if reason:
                        ...
                        # Early-halving cut. DISABLED Sep 16 14:25 UTC by widening:
                        # HALF_STOP_FRAC = 0.0 makes half_stop_px 0.0, so this branch
                        # is unreachable. Worker 6e994be9 measured it on 31 distinct
