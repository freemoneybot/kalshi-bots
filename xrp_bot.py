            ...
            if pos:
                if pos["ticker"] != m["ticker"]:
                    ...
                    if reason:
                        ...
                        # Early-halving cut. Only before minute 8, only while the
                        # trail has NOT armed - a ticket that already ran and is
                        # coming back down is the trail's business, not this rule's.
