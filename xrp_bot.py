                ...
                if pos["ticker"] != m["ticker"]:
                    ...
                    if reason:
                        ...
                        reason = (f"cut at {c(bid)}c - the bid halved to at or below "
                                  ...
                                  f"at minute {minute:.1f}, trail not armed. In our "
                                  f"own tape an early halving never recovered: 0 of "
                                  f"27 observations over 9 distinct rounds got back "
                                  f"to entry, best was 0.71x")
